/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e44c723b8fbd934cf823ff48c91cb3bc)
// Runtime types generated with workerd@1.20250525.0 2025-05-25 
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: "prod" | "test";
		BYPASS_AUTH: false | true;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		BASE_URL: string;
		CRON_INSERT_TEST_DB: DurableObjectNamespace /* CronInsertTestDb */;
		CUBORN_DB: D1Database;
		ASSETS: Fetcher;
	}
}
