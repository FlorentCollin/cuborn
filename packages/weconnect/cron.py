...
CREATE TABLE IF NOT EXISTS vehicle_status (
    ...
    charging_rate_kmph REAL,
    plug_status TEXT,
    target_soc REAL,
    remaining_charging_time INTEGER,
    climate_status TEXT,
    target_temp_celsius REAL,
    window_heating_front TEXT,
    window_heating_rear TEXT,
    doors_locked INTEGER,
    doors_front_left TEXT,
    doors_front_right TEXT,
    doors_rear_left TEXT,
    doors_rear_right TEXT,
    doors_trunk TEXT,
    doors_hood TEXT,
    window_front_left TEXT,
    window_front_right TEXT,
    window_rear_left TEXT,
    window_rear_right TEXT,
